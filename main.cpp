...
// 
    ...
    while (std::getline(std::cin, line)) {
            ...
            if (tempPassengerLabel=="ECONOMY") tempPassenger = std::make_shared<Economy>(idCounter,finalHandLuggage,finalLuggage);
            else if (tempPassengerLabel=="BUSINESS") tempPassenger = std::make_shared<Business>(idCounter,finalHandLuggage,finalLuggage);
            else if (tempPassengerLabel=="FIRST_CLASS") tempPassenger = std::make_shared<FirstClass>(idCounter,finalHandLuggage,finalLuggage);
